...
//        }
        ...
        int i = 1;//aca inicio en 1 para podes comparar los elementos del array empezando del segundo( ya que como maximo lo estoy inicializando al
                  //primero del array( lista[0])
        while (i < n) {
